...
app.controller('ReleaseCtrl', function ($rootScope, $scope, $route, $http, $location, $routeParams, ReleaseService, GenresService, ThemesService, limitToFilter, $filter, promiseTracker) {
